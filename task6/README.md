...
После исправления всех багов (ошибок), все проапгрейдилось нормально.
Но увидел, что при смене размеражесткого диска и при смене топологии провайдера со старой на более новые сервера - был пересоздан сервер с удалением жесткого диска.

Хотя написано что это из-за невозможности провайдером провести динамическое изменение размера....  проверю...  добавлю диск на web
до 8 гиг
